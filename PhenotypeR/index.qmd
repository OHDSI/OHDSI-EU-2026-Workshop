...
Marta Alcalde-Herraiz, Edward Burn
</p>
...
Help: You can check the arguments of the function using:
`??downloadClinicalDescriptionTemplate` or in the [**PhenotypeR website**](https://ohdsi.github.io/PhenotypeR/reference/index.html)
...
- If you were not able to create the shiny app, you can find it See the results in the [here](https://dpa-pde-oxford.shinyapps.io/PhenotypeRShiny_OHDSIEuropeWorkshop/)
