...
install.packages(c("omock", "OmopConstructor", "CohortConstructor",
                   "CohortSurvival", "readr"))
...
-   We will now instantiate our cohorts using [https://ohdsi.github.io/CohortConstructor/](CohortConstructor) R Package.
...
```{r, eval=FALSE}
# Hypertension
Information source: "Dynamed (Home - DynaMed)"
Introduction: 
...
```{r, eval=FALSE}
# Warfarin users
Information source: "Gemini (https://gemini.google.com/)"
Introduction: 
...
Information source: "Dynamed (https://www.dynamed.com/)"
Introduction: 
...
100% sure you've written and reviewed your code and now you're ready to see the answer?
...
Help: Explore `shinyDiagnostics()` documentation using ??shinyDiagnostics or in the website: [https://ohdsi.github.io/PhenotypeR/reference/index.html](https://ohdsi.github.io/PhenotypeR/reference/index.html)
