...
```{r}
cdm <- mockCdmFromDataset(datasetName = "delphi-100k", source = "duckdb")
...
requireEunomia(datasetName = "delphi-100k", cdmVersion = "5.4")
con <- dbConnect(drv = duckdb(dbdir = eunomiaDir(datasetName = "delphi-100k", cdmVersion = "5.4")))
cdm <- cdmFromCon(
  con = con, 
  cdmSchema = "main",
  writeSchema = "main"
